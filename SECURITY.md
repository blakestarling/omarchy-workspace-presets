...
The plugin does not request elevated privileges, install packages, or patch desktop configuration. Desktop launchers are referenced by ID, held to the form the entry scan itself produces, and custom launchers are validated JSON argv arrays.
